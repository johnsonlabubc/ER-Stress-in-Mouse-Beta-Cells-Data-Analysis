...
heatmap_list_total <- ComplexHeatmap::Heatmap(matrix_Z_score_total,
                                              ...
                                              row_names_side = "left",
                                              show_column_names = FALSE,
                                              col = circlize::colorRamp2(c(-ceiling(max(abs(matrix_Z_score_total))), 0, ceiling(max(abs(matrix_Z_score_total)))),
                                                                         c("blue", "white", "red")),
                                              show_row_dend = FALSE,
...
heatmap_list_total <- ComplexHeatmap::Heatmap(cormatrix,
                                              ...
                                              col = circlize::colorRamp2(c(-ceiling(max(abs(cormatrix))), 0, ceiling(max(abs(cormatrix)))),
                                                                         c("blue", "white", "red")),
                                              row_dend_side = "right",
